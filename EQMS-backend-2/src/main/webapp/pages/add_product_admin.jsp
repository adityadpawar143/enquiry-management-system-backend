	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="dashboard_admin"> <i class="bi bi-grid"></i> <span>Dashboard
						(Admin)</span>
			</a></li>
			<!-- End Dashboard Nav -->
			...
			<li class="nav-item"><a class="nav-link collapse show"
				...
				<ul id="charts-nav3" class="nav-content collapse show "
					...
					<li><a href="search_product_admin" class="active"> <i
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="search_product_admin">Product
							List</a></li>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Multi Columns Form -->
							<form action="addProductAdmin" method="post" class="row g-3 mt-2">
								<div class="text-center">
									<label class="form-label text-primary"><b>Category
											1/2</b> Added from Content Master.</label> <br>
									<label class="form-label text-primary">"Product Name +
										Category 1 + Category 2" combination will be used in enquiry.
									</label>
								</div>
								<div class="col-md-12">
									<label for="inputPassword5" class="form-label">Product
										Name</label> <input type="text" name="productName"
										class="form-control" id="inputPassword5">
								</div>
								<div class="col-md-6">
									<label for="inputState" class="form-label">Category 1</label> <select
										id="inputState" name="productCategory1" class="form-select">
										<option selected>Choose...</option>
										<option value="abc">abc</option>
									</select>
								</div>
								<div class="col-md-6">
									<label for="inputState" class="form-label">Category 2</label> <select
										id="inputState" name="productCategory2" class="form-select">
										<option selected>Choose...</option>
								...
								<div class="text-center">
									...
									<a type="reset" class="btn btn-secondary"
										href="search_product_super_admin">Cancel</a>
								</div>
							</form>
