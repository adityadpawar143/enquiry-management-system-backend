		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapse show"
				...
				<ul id="charts-nav3" class="nav-content collapse show "
					...
					<li><a href="search_user_admin" class="active"> <i class="bi bi-circle"></i><span>Manage User</span>
					</a></li>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="search_user_admin">User List</a></li>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
             <form action="addUserAdmin" method="post" class="row g-3 mt-2">
								...
								<div class="col-md-6">
									<label for="inputState" class="form-label">Role</label> <select
										...
										<option selected value="${user.userRole}">${user.userRole}</option>
										<option value="Admin">Admin</option>
								...
								<div class="col-md-12">
									<label for="inputName5" class="form-label">Company Name
										(Assigned By Admin)</label> <select id="inputState" class="form-select" name="userCompanyName">
										<option selected value="${user.userCompanyName}">${user.userCompanyName}</option>
								...
								<div class="col-md-4">
									<label for="inputZip" class="form-label">Zip</label> <input
										type="text" name="userZipcode" value="${user.userZipcode}"
										class="form-control" id="inputZip">
								</div>

								<div class="col-md-4">
									<label for="inputCity" class="form-label">Aadhar No.</label> <input
										type="text" name="userAadhar" value="${user.userAadhar}"
										class="form-control" id="inputCity">
								</div>
								<div class="col-md-4">
									<label for="inputState" class="form-label">PAN No.</label> <input
										type="text" name="userPan" value="${user.userPan}"
										class="form-control" id="inputCity">
								</div>
								<div class="col-md-4">
									<label for="inputZip" class="form-label">GST No.</label> <input
										type="text" name="userGST" value="${user.userGST}"
										class="form-control" id="inputZip">
								</div>
								<div class="col-12">
									<label for="inputAddress5" class="form-label">Remark</label> <input
										type="text" name="userRemark" value="${user.userRemark}"
										class="form-control" id="inputAddres5s">
								</div>
								<input name="userDoc" value="${user.userDoc}" type="hidden" >
								<input name="userProof" type="hidden" value="${user.userProof}">
								<div class="row mt-3 mb-3">
									<div
										class="col-md-12 bg-secondary text-light text-center pt-3 pb-2 mb-3">
										<label for="inputState" class="form-label">Uploaded
											Document</label>
									</div>
								...
								<div class="text-center">
									...
									<a type="reset" class="btn btn-secondary"
										href="search_user_super_admin">Cancel</a>
								</div>
							</form>
