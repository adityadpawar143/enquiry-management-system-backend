		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapse show"
				...
				<ul id="charts-nav2" class="nav-content collapse show "
					data-bs-parent="#sidebar-nav">
					<li><a href="enquiry_report_admin" class="active"> <i class="bi bi-circle"></i><span>Added
								Data Report</span>
					</a></li>
					<li><a href="enquiry_report_memberwise_admin"> <i class="bi bi-circle"></i><span>Added
