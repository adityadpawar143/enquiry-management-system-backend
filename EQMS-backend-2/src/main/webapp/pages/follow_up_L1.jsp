...
<title>EQMS - Enquiry Follow-up</title>
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapse show"
				...
				<ul id="charts-nav" class="nav-content collapse show "
					...
					<li><a href="follow_up_L1" class="active"> <i
							class="bi bi-circle"></i><span>Enquiry Follow-up</span>
					</a></li>
				</ul></li>
			<!-- End Charts Nav -->
									...
									<c:forEach var="e" items="${enquiry}">
										<tr>
											...
											<td class="text-center"><a
												href="follow_up_action_L1?id=${e.enquiryId}">Follow-up</a>
												<hr class="py-0 my-0"> <a
												href="follow_up_view_L1?id=${e.enquiryId}">View</a></td>
