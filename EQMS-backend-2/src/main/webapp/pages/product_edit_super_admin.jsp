		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapse show"
				...
				<ul id="charts-nav3" class="nav-content collapse show "
					data-bs-parent="#sidebar-nav">
					<li><a href="search_user_super_admin"> <i class="bi bi-circle"></i><span>Manage User</span>
					</a></li>
					<li><a href="search_product_super_admin" class="active"> <i
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="search_product_super_admin">Product List</a></li>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form action="addProduct" method="post" class="row g-3 mt-2">
               <input type="hidden" name="productId" value="${product.productId}">
                <div class="col-md-12">
                  <label for="inputPassword5" class="form-label">Product Name</label>
                  <input type="text" name="productName" value="${product.productName}"class="form-control" id="inputPassword5">
                </div>
                <div class="col-md-6">
                  <label for="inputState" class="form-label">Category 1</label>
                  <select id="inputState" name="productCategory1" class="form-select">
                    <option selected value="${product.productCategory1}">${product.productCategory1}</option>
                    <option value="abc">abc</option>
                  </select>
                </div>
                <div class="col-md-6">
                  <label for="inputState" class="form-label">Category 2</label>
                  <select id="inputState" name="productCategory2" class="form-select">
                    <option selected value="${product.productCategory2}">${product.productCategory2}</option>
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" name="productDescription" value="${product.productDescription}" class="form-control" id="inputPassword5">
                </div>

                
                <div class="text-center">
                  <input type="submit" class="btn btn-primary" value="Update">
                  <a type="reset" class="btn btn-secondary" href="search_product_super_admin">Cancel</a>
                </div>
