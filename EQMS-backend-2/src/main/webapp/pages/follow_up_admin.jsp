...
<title>EQMS - Enquiry Follow-up List</title>
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link "
				...
				<ul id="forms-nav" class="nav-content collapse show"
					...
					<li><a href="follow_up_admin" class="active"> <i
									...
									<c:forEach var="e" items="${enquiry}">
										<tr>
											...
											<td class="text-center"><a
												href="follow_up_action_admin?id=${e.enquiryId}">Follow-up</a>
												<hr class="py-0 my-0"> <a
												href="follow_up_view_admin?id=${e.enquiryId}">View</a></td>
