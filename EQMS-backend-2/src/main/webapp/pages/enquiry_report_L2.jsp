...
<body>
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed" href="dashboard_L2">
			...
			<!-- End Charts Nav -->
				...
				<ul id="charts-nav2" class="nav-content collapse show "
					data-bs-parent="#sidebar-nav">
					<li><a href="enquiry_report_L2" class="active"> <i class="bi bi-circle"></i><span>Added
								Data Report</span>
					</a></li>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			<h1>Added Enquiry Report (Member)</h1>
