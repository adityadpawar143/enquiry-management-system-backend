...
<div class="row mt-2 mb-2">
    <p class="text-primary ml-5">*Admin: Can add/edit product. Delete restricted.</p>
      <div class="col-6">
        <a class="btn btn-primary ms-3" href="add_product_super_admin">Add New</a>
      </div>
						...
						<div class="card-body">
							...
							<table class="table datatable">
								...
								<c:forEach var="e" items="${productList}">
									<tr>
										<td><b>${e.productId}</b></td>
										<td>${e.productName}</td>
										<td>${e.productCategory1}</td>
										<td>${e.productCategory2}</td>
										<td>${e.productDescription}</td>
										<td>
											<a href="product_edit_super_admin?id=${e.productId}">Edit</a> | 
											<a class="text-danger" href="product_delete?id=${e.productId}">Delete</a>
									    </td>
