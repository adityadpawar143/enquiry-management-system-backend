...
<div class="row mt-2 mb-2">
    <p class="text-primary ml-5">*Admin: Add Member L2/L3 | Reset Password for L2/L3 member | Delete restricted.</p>
      <div class="col-6">
        <a class="btn btn-primary ms-3" href="add_user_admin">Add New</a>
      </div>
							...
							<table class="table datatable">
								...
								<c:forEach var="e" items="${userList}">
									<tr>
										...
										<td>${e.userPRN}</td>
										<td>
											<a href="user_edit_admin?id=${e.userId}">Edit</a> | 
											<a class="text-danger" href="user_delete_admin?id=${e.userId}">Delete</a>
									    </td>
