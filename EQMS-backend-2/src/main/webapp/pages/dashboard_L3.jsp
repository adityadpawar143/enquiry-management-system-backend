...
<body>
	...
	<header id="header" class="header fixed-top d-flex align-items-center">
		...
		<div class="d-flex align-items-center justify-content-between">
			<a href="dashboard_L3" class="logo d-flex align-items-center"> <img
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link" href="dashboard_L3">
					<i class="bi bi-grid"></i> <span>Dashboard (L3)</span>
			</a></li>
			<!-- End Dashboard Nav -->
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="charts-nav" class="nav-content collapse "
					...
					<li><a href="add_enquiry_L3"> <i class="bi bi-circle"></i><span>Add
								Enquiry</span>
					</a></li>
						...
						<div class="card-body">
							...
							<table class="table datatable">
								<thead>
									<tr>
										<th>#</th>
										<th data-type="date" data-format="DD/MM/YYYY">Enquiry Date</th>
										<th>Customer Name</th>
										<th>Mobile</th>
