...
<div class="row mt-2 mb-2">
    <p class="text-primary ml-5">*Admin: Can add/edit product. Delete restricted.</p>
      <div class="col-6">
        <a class="btn btn-primary ms-3" href="add_product_admin">Add New</a>
      </div>
							...
							<table class="table datatable">
								...
								<c:forEach var="e" items="${productList}">
									<tr>
										...
										<td>
											<a href="product_edit_admin?id=${e.productId}">Edit</a> | 
											<a class="text-danger" href="product_delete_admin?id=${e.productId}">Delete</a>
									    </td>
