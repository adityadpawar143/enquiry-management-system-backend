            ...
            <div class="card-body">
              ...
              <form action="addProduct" method="post" class="row g-3 mt-2">
                <div class="text-center">
                  <label class="form-label text-primary"><b>Category 1/2</b> Added from Content Master.</label>
                  <br><label class="form-label text-primary">"Product Name + Category 1 + Category 2" combination will be used in enquiry. </label>
                </div>
                <div class="col-md-12">
                  <label for="inputPassword5" class="form-label">Product Name</label>
                  <input type="text" name="productName" class="form-control" id="inputPassword5">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" name="productDescription" class="form-control" id="inputPassword5">
                </div>
