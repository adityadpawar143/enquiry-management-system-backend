...
<body>
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="dashboard_L2"> <i class="bi bi-grid"></i> <span>Dashboard
						(L2)</span>
			</a></li>
			<!-- End Dashboard Nav -->
			...
			<li class="nav-item"><a class="nav-link "
				...
				<ul id="forms-nav" class="nav-content collapse show"
					...
					<li><a href="add_enquiry_L2" class="active"> <i
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard_L2">Home</a></li>
				...
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							...
							<!-- Vertical Form -->
							<form action="addEnquiryL2" method="post" class="row g-3">
								<div class="col-6">
								...
								<input type="hidden" name="enquiryCreatedBy" value="L2-Member">
