...
<body>
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="charts-nav3" class="nav-content collapse "
					...
					<li><a href=""> <i class="bi bi-circle"></i><span>Manage User</span>
					</a></li>
					<li><a href=""> <i
			...
			<li class="nav-item"><a class="nav-link collapse show"
				...
				<ul id="charts-nav2" class="nav-content collapse show "
					...
					<li><a href="enquiry_report_memberwise_admin" class="active"> <i class="bi bi-circle"></i><span>Added
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			<h1>Added Enquiry Report (Memberwise)</h1>
			</div>
		<div class="pagetitle">
			</div>
		<!-- End Page Title -->
