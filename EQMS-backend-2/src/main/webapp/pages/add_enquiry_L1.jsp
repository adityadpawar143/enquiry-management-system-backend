...
<body>
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="dashboard_L1"> <i class="bi bi-grid"></i> <span>Dashboard
						(L1)</span>
			</a></li>
			<!-- End Dashboard Nav -->
			...
			<li class="nav-item"><a class="nav-link "
				...
				<ul id="forms-nav" class="nav-content collapse show"
					...
					<li><a href="add_enquiry_L1" class="active"> <i
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="charts-nav2" class="nav-content collapse "
					...
					<li><a href=""> <i class="bi bi-circle"></i><span>Dummy
								Report 1</span>
					</a></li>
					<li><a href=""> <i class="bi bi-circle"></i><span>Dummy
								Report 2</span>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard_L1">Home</a></li>
				...
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							...
							<!-- Vertical Form -->
							<form action="addEnquiryL1" method="post" class="row g-3">
								<div class="col-6">
								...
								<div class="col-6">
									<label for="inputNanme4" class="form-label">Product
										Name + Category 1 + Category 2</label> <select id="inputState"
										name="enquiryProductName" class="form-select">
										<option selected disabled>Choose...</option>
										<c:forEach var="e" items="${P1}">
											<option
												value="${e.productName},${e.productCategory1},${e.productCategory2}">${e.productName}
												+ ${e.productCategory1} + ${e.productCategory2}</option>
										</c:forEach>
									</select>
								</div>
								<div class="col-6">
								...
								<input type="hidden" name="enquiryCreatedBy" value="L1-Member">
