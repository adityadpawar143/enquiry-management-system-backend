              ...
              <form action="addUserAdmin" method="post" class="row g-3 mt-2">
								...
								<div class="col-md-4">
									<label for="inputCity" class="form-label">Aadhar No.</label> <input
										type="text" name="userAadhar" class="form-control" id="inputCity">
								</div>
								<div class="col-md-4">
									<label for="inputState" class="form-label">PAN No.</label> <input
										type="text" name="userPan" class="form-control" id="inputCity">
								</div>
								<div class="col-md-4">
									<label for="inputZip" class="form-label">GST No.</label> <input
										type="text" name="userGST" class="form-control" id="inputZip">
								</div>
								<div class="col-12">
									<label for="inputAddress5" class="form-label">Remark</label> <input
										type="text" name="userRemark" class="form-control" id="inputAddres5s">
								</div>
